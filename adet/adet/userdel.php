<?php
    $iduser = $_GET["p1"];
    $sql = "SELECT tu.nama, tu.email,tu.nim, tu.username FROM tbuser tu WHERE tu.iduser='$iduser';";
...
<form method="POST" action="datauser.php">
    ...
    <div class="form-floating mb-3">
        <input type="text" name="txNIM" class="form-control" id="floatingInput" placeholder="NIM anda..." value="<?=$h["nim"]?>">

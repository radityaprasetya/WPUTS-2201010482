        ...
        switch ($act){
            case "store":
                ...
                if($pass1 == $pass2){
                    ...
                    $user = $_POST["txUSER"];
                    $iduser = md5($email);
                    $sql = "INSERT INTO tbuser(nama, email, nim, username, password, iduser) VALUES('$nama', '$email','$nim', '$user', '$pass1', '$iduser');";
            ...
            case "update":
                    ...
                    $user = $_POST["txUSER"];
                    $iduser = $_POST["iduser"];
                    $sql = "UPDATE tbuser SET nama='$nama', email='$email', nim='$nim', username='$user'WHERE iduser='$iduser';";
                    $hasil = mysqli_query($cnn, $sql);
                    if($hasil){
                        $footer = "<script>
                        Swal.fire({
